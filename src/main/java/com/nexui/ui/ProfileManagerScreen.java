...
public class ProfileManagerScreen extends Screen {
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY, float delta) {
        ...
        // Header
        context.drawString(context.getClient().font, "NexUI Interface Layout Profiles", 50, 48, ColorRGBA.ACCENT_BLUE.toARGB(), false);
        context.drawString(context.getClient().font, "Switch profiles instantly for different playstyles or export/import JSON presets.", 50, 64, 0xAAFFFFFF, false);
        ...
        for (int i = 0; i < profiles.size(); i++) {
            ...
            context.drawString(context.getClient().font, profile.getName() + (isActive ? " [ACTIVE]" : ""), startX + 16, y + 10, isActive ? ColorRGBA.ACCENT_CYAN.toARGB() : ColorRGBA.WHITE.toARGB(), false);
            context.drawString(context.getClient().font, profile.getDescription(), startX + 16, y + 26, 0xAAFFFFFF, false);
        }
    }
