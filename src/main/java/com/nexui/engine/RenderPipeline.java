 ...
 *
 * Minecraft 26.2 replaced {@code GuiGraphics} with {@code GuiGraphicsExtractor};
 * the 5-arg {@code fill} used here has the same signature on both.
 */
public class RenderPipeline {

    public static void renderStyledPanel(GuiGraphicsExtractor context, Rect2i bounds, ComponentStyle style) {
    ...
    public static void renderSelectionOutline(GuiGraphicsExtractor context, Rect2i bounds, boolean isPrimary) {
    ...
    public static void renderAlignmentGuide(GuiGraphicsExtractor context, AlignmentGuideEngine.AlignmentGuide guide, int screenWidth, int screenHeight) {
